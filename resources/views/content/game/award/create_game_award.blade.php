...
@section('title', 'Criar prêmio de jogo de Jogo')
...
<div class="container mt-4">
  <div class="card">
    <div class="card-header">
      <h5>Criar prêmio de jogo do Jogo</h5>
    </div>
    <div class="card-body">
      <form action="{{ route('store-game-award', $game->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
          ...
          <textarea
            ...
            disabled
            rows="3"
            required>{{ old('game_name', $game->name) }}</textarea>
        </div>
        ...
        <div class="mb-3">
          ...
          <select class="form-select" id="condition_type" name="condition_type" required>
            ...
            <option value="LOWEST_POINT">Pé Frio</option>
        ...
        <a href="{{ route('show-game', ['id' => $game->id]) }}" class="btn btn-secondary">Cancelar</a>
      </form>
    </div>
  </div>
</div>
