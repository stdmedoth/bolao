...
@section('content')
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs flex-wrap" id="gameTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ $tab == 'tab-details' ? 'active' : '' }}" id="details-tab" data-bs-toggle="tab"
                    href="#details" role="tab" aria-controls="details"
                    aria-selected="{{ $tab == 'tab-details' }}">Detalhes</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ $tab == 'tab-bet' ? 'active' : '' }}" id="bet-form-tab" data-bs-toggle="tab"
                    href="#bet-form" role="tab" aria-controls="bet-form"
                    aria-selected="{{ $tab == 'tab-bet' }}">Apostar</a>
            </li>
            <!-- Demais abas não alteradas -->
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ $tab == 'tab-mybets' ? 'active' : '' }}" id="mybets-tab" data-bs-toggle="tab"
                    href="#mybets" role="tab" aria-controls="mybets" aria-selected="{{ $tab == 'tab-mybets' }}">Minhas
                    apostas</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ $tab == 'tab-results' ? 'active' : '' }}" id="results-tab" data-bs-toggle="tab"
                    href="#results" role="tab" aria-controls="results"
                    aria-selected="{{ $tab == 'tab-results' }}">Resultados</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ $tab == 'tab-winners' ? 'active' : '' }}" id="winners-tab" data-bs-toggle="tab"
                    href="#winners" role="tab" aria-controls="winners"
                    aria-selected="{{ $tab == 'tab-winners' }}">Ganhadores</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ $tab == 'tab-prizes' ? 'active' : '' }}" id="prizes-tab" data-bs-toggle="tab"
                    href="#prizes" role="tab" aria-controls="prizes"
                    aria-selected="{{ $tab == 'tab-prizes' }}">Prêmios</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ $tab == 'tab-rules' ? 'active' : '' }}" id="rules-tab" data-bs-toggle="tab"
                    href="#rules" role="tab" aria-controls="rules"
                    aria-selected="{{ $tab == 'tab-rules' }}">Regras</a>
            </li>
        </ul>
        ...
        <div class="tab-content mt-4" id="gameTabsContent">
            ...
            <div class="tab-pane fade {{ $tab == 'tab-bet' ? 'show active' : '' }}" id="bet-form" role="tabpanel"
                            ...
                            <form id="bet_form" action="{{ route('purchase-store', $game->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="seller_id">
                                            <option value="{{ auth()->user()->id }}"
                                                {{ old('seller_id') == auth()->user()->id ? 'selected' : '' }}>Banca
                                                Central</option>
                                ...
                                <div class="form-group" id="text_input_container">
                                    <div id="text_input_container">
                                        <div class="form-group">
                                            <label for="manual_numbers">Digite suas dezenas (máximo de 11 números, ex: 11
                                                22 33 44):</label>
                                            <input type="text" inputmode="numeric" class="form-control"
                                                id="manual_numbers" placeholder="Ex: 11 22 33 10 99" maxlength="32">
                                            <small id="error-message1" class="text-danger"
                                ...
                                <div class="card" id="grid_input_container" style="display: none;">
                                    <div class="card-body">
                                        ...
                                        <small class="form-text text-muted">Selecione até 11 números. Clique novamente em
                                            um número para desmarcá-lo.</small>
            ...
            <div class="tab-pane fade {{ $tab == 'tab-results' ? 'show active' : '' }}" id="results" role="tabpanel"
                ...
                @if (auth()->user()->role->level_id == 'admin')
                    <form id="result_form" action="{{ route('add-game-history', $game->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="result_numbers">Escolha suas dezenas (11 números por vez, separados por
                                espaços)</label>
                            <input type="text" class="form-control" id="result_numbers" name="result_numbers"
                                placeholder="Exemplo: 1111 2211 1211 3211 1211 4311 1211 5411 6511 2311 1211" required>
                            <small class="form-text text-muted">As dezenas devem ter dois dígitos cada e serem separadas
                                por espaços, em grupos de 11 números.</small>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="/concursos/resultados/historico/edit/{{ $history->id }}"><i
                                                                class="bx bx-edit-alt me-1"></i> Editar</a>
                                                        <a class="dropdown-item"
                                                            href="/concursos/resultados/historico/remove/{{ $history->id }}"><i
                                                                class="bx bx-x me-1"></i> Remover</a>
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="card-body">
                                                ...
                                                <p class="card-text"><small class="text-muted">Cadastrado:
                                                        {{ $history->created_at->format('d/m/Y H:i') }}</small></p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
            ...
            <div class="tab-pane fade {{ $tab == 'tab-prizes' ? 'show active' : '' }}" id="prizes" role="tabpanel"
                ...
                @if (auth()->user()->role->level_id == 'admin')
                    <a href="{{ route('create-game-award-form', $game->id) }}" class="btn btn-primary">Criar novo
                        prêmio</a>
                @endif
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        @if (auth()->user()->role->level_id == 'admin')
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                        href="/concursos/premios/edit/{{ $award->id }}"><i
                                                            class="bx bx-edit-alt me-1"></i> Editar</a>
                                                    <a class="dropdown-item"
                                                        href="/concursos/premios/remove/{{ $award->id }}"><i
                                                            class="bx bx-x me-1"></i> Remover</a>
                                        ...
                                        @if ($award->condition_type === 'WINNER')
                                            Quem fizer <strong> {{ $award->winner_point_value }} </strong> pontos vence o
                                            torneio em primeiro<br>
                                        @endif
                                        @if ($award->condition_type === 'LOWEST_POINT')
                                            Quem fizer <strong> menos </strong> pontos ganha<br>
                                        @endif
                                        <strong>Valor do prêmio:</strong> R$
                                        {{ number_format($award->amount, 2, ',', '.') }} <br>
                                    </li>
                                @endforeach
                            </ul>
                        @endif
            ...
            <div class="tab-pane fade {{ $tab == 'tab-rules' ? 'show active' : '' }}" id="rules" role="tabpanel"
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">3. Só valem as dezenas do 1º ao 5º, conforme mostrado no exemplo.
                            </li>
                            ...
                            <li class="list-group-item">6. Não havendo ninguém com 10 dezenas, o segundo lugar será para
                                quem estiver na sequência.</li>
                            ...
                            <li class="list-group-item">9. Em caso de empate nos prêmios, o valor será dividido entre os
                                ganhadores.</li>
                            <li class="list-group-item">10. Faça seu jogo em local de sua confiança. Prêmios pagos
                                diretamente no local.</li>
                                    ...
                                    <td>
                                        ...
                                        @if (auth()->user()->role->level_id == 'admin')
                                            <a href="{{ route('user_award-pay', $winner->id) }}"
                                                class="btn btn-success {{ $winner->status == 'PAID' ? 'disabled' : '' }}">Pagar</a>
                                        @endif
                                        @if (auth()->user()->role->level_id == 'admin' && $winner->status == 'PAID')
                                            <a href="{{ route('user_award-withdraw', $winner->id) }}"
                                                class="btn btn-info {{ $winner->status !== 'PAID' ? 'disabled' : '' }}">Estornar</a>
                                        @endif
                                    </td>
                                </tr>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const errorMessage = isGridSelected ? document.getElementById('error-message2') : document
            ...
            document.querySelectorAll('input[name="selection_method"]').forEach(input => {
                input.addEventListener('change', function() {
                    if (this.id === 'use_grid') {
                        ...
                        document.querySelectorAll('.number-button').forEach(button => button
            ...
            document.getElementById('bet_form').addEventListener('submit', function(e) {
                ...
                if (isGridSelected && selectedNumbers.length !== maxNumbers) {
                    ...
                    document.getElementById('error-message2').textContent =
                        'Você deve selecionar exatamente 11 números.';
                    ...
                    if (manualNumbers.length !== maxNumbers) {
                        ...
                        document.getElementById('error-message1').textContent =
                            `Insira exatamente ${maxNumbers} dezenas válidas separadas por espaços.`;
                ...
                button.addEventListener('click', function() {
                    ...
                    if (selectedNumbers.includes(number)) {
                        ...
                        if (selectedNumbers.length < maxNumbers) {
                            ...
                            document.getElementById('error-message2').textContent =
                                `Você só pode selecionar até ${maxNumbers} números.`;
                            document.getElementById('error-message2').style.display = 'block';
                            return;
                        }
                    }
