          ...
          <form id="formAuthentication" class="mb-6" action="{{route('register-validate')}}" method="POST">
            <div class="mb-6">
              ...
              <div class="mb-6">
                ...
                <input id="document" maxlength="14" type="text" class="form-control" id="document" oninput="cpf" name="document" placeholder="Insira seu documento" autofocus>
              </div>
              ...
              <input type="hidden" id="refered_by_id" class="form-control" name="refered_by_id" value="{{isset($refered_by_id) ? $refered_by_id : ''}}" />
