...
<div class="card">
  ...
  <div class="card-body">
    ...
    <form id="depositForm" action="{{ route('deposit-create-credit-card') }}" method="POST">
      @endif
          ...
          <div class="col">
            <div class="row">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="amount" name="amount" placeholder="Digite o valor" value="{{session('amount', old('amount'))}}" required>
                <small class="text-danger" id="error-message" style="display: none;">O valor deve ser no mínimo R$ 5,00.</small>
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="payment_method" id="payment_method">
                  <option {{($payment_method == 'credit_card') ? 'selected' : ''}} value="credit_card">Cartão Credito</option>
